...
@Component({
  selector: 'app-reserved-salles',
  templateUrl: './reserved-salles.component.html',
  styleUrls: ['./reserved-salles.component.css']
})
export class ReservedSallesComponent {
  consultData: any = {};
  salles: Salle[] = [];
  ...
  onConsult(): void {
    ...
    const url = 'http://localhost:2222/RESERVATIONSALLE-SERVICE/ReservationSalle/reservedSalles';
